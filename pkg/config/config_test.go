...
func TestHarvesterConstructedAddonsFileRendering(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			harvConfig: &HarvesterConfig{},
			fname:      "/go/src/github.com/harvester/harvester-installer/pkg/config/testdata/rancherd-22-fake-addons.yaml",
			rendError:  true,
		},
		{
			name:            "error when addon file is not templated",
			harvConfig:      &HarvesterConfig{},
			fname:           "/go/src/github.com/harvester/harvester-installer/pkg/config/testdata/rancherd-22-not-templated-addons.yaml",
			rendError:       false,
		...
		},
		{
			...
			harvConfig:      &HarvesterConfig{},
			fname:           "/go/src/github.com/harvester/harvester-installer/pkg/config/testdata/rancherd-22-good-addons.yaml",
			rendError:       false,
